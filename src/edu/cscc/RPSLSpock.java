...
/**
 * Rock, Paper, Scissors, Spock, Lizard class
 * @author Maryan Gelyk
 * @version 1.0
 */
public class RPSLSpock {
    ...
    /**
     *
     * @param pick checks user's input
     * @return false or user's pick (Rock, Paper, Scissors, Spock, Lizard)
     */
    ...
    /**
     *
     * @param c_pick user's pick
     * @param h_pick computer's pick
     * @return checks if computer won
     */
